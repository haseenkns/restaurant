    ...
    <div class="main-container">
        ...
        <div class="span12">
          <div class="widget no-margin">
            <div class="widget-header">
              <div class="title"> <span class="fs1" aria-hidden="true" data-icon="&#xe170;"></span> Upcoming Competition  </div>
            </div>
            <div class="widget-body">
              <div class="row-fluid">
                <div class="span12">
                  <div class="row-fluid">
                    <div class="span12">
                      <h4><strong><a href="#">Wild Life Competition</a></strong></h4>
                    </div>
                  </div>
                  <div class="row-fluid">
                    <div class="span4"> <a href="#" class="thumbnail"> <img src="img/2.jpg" alt=""> </a> </div>
                    <div class="span8">
                      <p> Lorem Ipsum is simply dummy text of the prikntjhjing and typesettihjkng industry. Lorem Ipsum has been the industryhjk's standard dummy text ever since the 150h, wjen kn unknk printer tkjoohkjbledjkghj it to make a tkj specimen boohhjjk. It has shjurvivedkknot only five centuries, but also the leap into electronic typesetting, remaikhjkh. It was popularised inkhjkthe 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like hjincluding versions of Lorem Ipsum. </p>
                      <!--<p><a class="btn btn-info" href="member_selection.php">Apply</a></p>-->
                    </div>
                  </div>
                  <div class="row-fluid">
                    <div class="span12">
                      <p></p>
                      <p class="icomoon-small"> <span class="fs1" aria-hidden="true" data-icon="&#xe070;"></span> by <a href="#">Super Admin</a> | <span class="fs1" aria-hidden="true" data-icon="&#xe052;"></span> Mar 16th, 2013
                        | <span class="fs1" aria-hidden="true" data-icon="&#xe1c3;"></span> <a href="#">7 applyed</a> | <a href="competition_guidelines.php"><span class="label label-important">Competition  Guidelines</span></a></p>
                    </div>
                  </div>
      ...
      <div class="row-fluid" style="margin-top:20px;">
        <div class="span12">
          <div class="widget no-margin">
            <div class="widget-header">
              <div class="title"> <span class="fs1" aria-hidden="true" data-icon="&#xe00d;"></span> New or unrate Uploaded Images</div>
            </div>
            <div class="widget-body">
			 <div class="widget-body">
                  ...
                  <div id="accordion1" class="accordion no-margin">
                     <div class="accordion-group">
                      ...
                      <td width="15%"> 
                        ...
                        <tr> <td colspan="2">
                         <div class="span3">
                         <a href="photo_detail.php" class="thumbnail" ><img src="img/2.jpg" alt=""></a>
                        </div> <div class="span3">
                          <a href="photo_detail.php" class="thumbnail"><img src="img/2.jpg" alt=""></a>
                        </div> <div class="span3">
                          <a href="photo_detail.php" class="thumbnail"><img src="img/2.jpg" alt=""></a>
        ...
        <!--<div class="span4">
          <div class="widget no-margin">
            <div class="widget-header">
              <div class="title"> <span class="fs1" aria-hidden="true" data-icon="&#xe098;"></span> Lorem Ipsum <span class="mini-title"> Lorem Ipsum </span> </div>
            </div>
            <div class="widget-body">
             <div id="area_chart" class="hidden"></div>
              <ul class="stats">
                <li>
                  <div class="left">
                    <h4> 00 </h4>
                  ...
                  <div class="chart"> <span id="unique-visitors"> 2, 4, 3, 7, 9, 8, 2, 5, 2, 8, 9 </span> </div>
                </li>
                <li>
                  <div class="left">
                    <h4> 00 </h4>
                  ...
                  <div class="chart"> <span id="monthly-sales"> 3, 9, 8, 5, 3, 5, 2, 4, 1, 6, 9 </span> </div>
                </li>
                <li>
                  <div class="left">
                    <h4> 00 </h4>
                  ...
                  <div class="chart"> <span id="current-balance"> 5, 9, 2, 7, 4, 9, 3, 7, 1, 4, 2 </span> </div>
                </li>
              </ul>
            </div>
          </div>
	  ...
	  <br/><br/>
	   <div class="row-fluid">
        <div class="span12">
         <div class="widget no-margin">
            <div class="widget-header">
              <div class="title"> <span class="fs1" aria-hidden="true" data-icon="&#xe00d;"></span> Rated Images</div>
            </div>
            <div class="widget-body">
			 <div class="widget-body">
