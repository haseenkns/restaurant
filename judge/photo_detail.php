        ...
        <div class="span12">
          <div class="widget no-margin">
            <div class="widget-header">
              <div class="title"> <span class="fs1" aria-hidden="true" data-icon="&#xe170;"></span> Competition  Image Details</div>
            </div>
              ...
              <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="span8">
						...
						<div class="img-module-btn">
							<form method="post" action="#">
								<!--<input type="number" name="categoryname" required="" id="category-feild" placeholder="Rate us" value="">
								<button class="btn btn-success input-top-margin" id="success" data-original-title="" type="submit">upload image</button>-->
								...
								<div class="control-group">
								  ...
								  <div class="controls">
									<input type="number" id="lastName" style="padding: 5px 10px;display: block;"  value="0" class="span12" />
								  </div>
								</div>
								...
								<div class="control-group">
								  ...
								  <div class="controls">
									<textarea type="number" id="lastName" style="padding: 5px 10px;display: block;"  value="0" class="span12"> Write your comment</textarea>
								  </div>
								</div>
								
							</form>
								
								<a data-original-title="" class="btn btn-info" href="#" style="float:right;">Save</a>
						</div>
                  ...
                  <div class="row-fluid">
                    <div class="span12">
                      <p></p>
                      <p class="icomoon-small"><span class="fs1" aria-hidden="true" data-icon="&#xe052;"></span> Mar 16th, 2013
                        </p>
                    </div>
                  </div>
