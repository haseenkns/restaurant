			...
			<div class="container">
				...
				<div class="page-header">
					<div class="page-title">
						<h3>Send Table Reservation Mail </h3>
					</div>
...
<form action="" method="post" enctype="multipart/form-data" onSubmit="return ValidateMember()">
 <?php if($msg!=''){ ?>
  ...
  <th width="5%" >Sno</th>
             ...
             <th width="25%"  data-hide="phone">Name</th>
             <th width="20%"  data-hide="phone,tablet" style="text-align:center;"> Send Mail</th>
  </tr>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td align="center"  ><a href="sendtablereservation.php?aid=<?php echo base64_encode( $fetch['id']); ?>"  ><img src="images/welcome.png"> </a></td>
