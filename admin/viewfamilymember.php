...
if(isset($_GET['aid'])&&$_GET['aid']!=''){
	...
	$edtQry=mysql_query("Select * from `familymembers` where `id`='$aid'");
		...
		<div id="content">
			<div class="container">
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> View Family Member detail </h4>
							</div>
              ...
              <tr>
                ...
                <tr >
				<td align="left" class="blackbold"> Relation</td>
				<td><?php echo getTabledataById("name","relations",$userData[8]); ?></td>
				<td><div class="validateText"></div></td>
				</tr>
                ...
                <tr>
				<td  class="blackbold" colspan="3" align="center"><input style="width:200px;" type="button" name="cancel" value="  Go Back  " onClick="javascript:window.location.href='familymembers.php?aid=<?php echo base64_encode($memId); ?>'" class="btn"> </td>
