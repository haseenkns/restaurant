     ...
     <script>
		function seachByDate(start,end,program){
			...
			//}else{
				if(start=='')start=0;
				if(end=='')end=0;
				window.location.href="membersvalidity.php?start="+start+"&end="+end+'&pg='+program;	
			//}
		}
    </script> 
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> Members <a href="reports/membersvalidity.php?start=<?php echo $start; ?>&end=<?php echo $end; ?>&type=1&pg=<?php echo $pg ?>"><img src="images/excel.png" width="24" height="24"></a>&nbsp;&nbsp;<a href="reports/membersvalidity.php?start=<?php echo $start; ?>&end=<?php echo $end; ?>&type=2&pg=<?php echo $pg ?>"><img src="images/word.png" width="26" height="26"></a></h4>
