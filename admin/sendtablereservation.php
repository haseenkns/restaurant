...
if(isset($_GET['aid'])&&$_GET['aid']!=''){
	...
	$contacts=getMemberContact($aid);
	$address=getMemberAddress($aid);
	
	$prog_id=$userData[1];
	$date=date("d/m/Y");
	$progArr=getProgramDescriptionById($prog_id);
	$mem_no=getMemberShipNumber($prog_id,$aid);
	
	$progEmail=htmlentities(stripslashes($progArr[2]));
	$progTo=htmlentities(stripslashes($progArr[18]));
	$progName=htmlentities(stripslashes($progArr[1]));
	$progTemplatesArr=getProgramTemplatesById($prog_id);
	
	$subject=htmlentities(stripslashes($progTemplatesArr[12]));
	
	$progContent=htmlentities(stripslashes($progTemplatesArr[13]));
	$ack=stripslashes($progTemplatesArr[16]);
	$remark=htmlentities(stripslashes($progTemplatesArr[14]));
	$content=$date."<br/><br/>".$progContent;
	
	//$mailsent=checkRoomMailSent($aid);
			...
			<div class="container">
			 ...
			 <?php }?>
              ...
              <tr>
				...
				<form action="previewtablemail.php" name="user" method="post"  class="form-horizontal row-border" id="validate-1"> 
				...
				<td><input type="text" class="form-control " placeholder="Add Email " name="fromemail" id="fromemail" value="<?php echo $progEmail; ?>"></td>
				<td></td>
				</tr>
                <tr >
				<td align="left" class="blackbold">To *</td>
				<td><input type="text" class="form-control tags" placeholder="Add Email " name="toemail" id="toemail" value="<?php echo $progTo; ?>"></td>
				<td></td>
				</tr>
				...
				<td><input type="text" class="form-control input-width-xlarge "  placeholder="Add Name " name="membername" id="membername" value="<?php echo $mem_name; ?>"></td>
				<td></td>
				</tr>
                <tr >
				<td align="left" class="blackbold">Membership Number *</td>
				<td><input type="text" class="form-control input-width-xlarge" placeholder="Add membership No " name="membernumber" id="membernumber" value="<?php echo $mem_no; ?>"></td>
				<td></td>
				</tr>
                <tr >
				<td align="left" class="blackbold">Address *</td>
				<td><input type="text" class="form-control input-width-xxlarge" placeholder="Add Address " name="address" id="address" value="<?php echo $address; ?>"></td>
				<td></td>
				</tr>
                <tr >
				<td align="left" class="blackbold">Contact Number *</td>
				<td><input type="text" class="form-control input-width-xlarge" placeholder="Add Contact Number " name="contact" id="contact" value="<?php echo $contacts ?>"></td>
				<td></td>
				</tr>
                <tr >
				<td align="left" class="blackbold">Email Id *</td>
				<td><input type="text" class="form-control input-width-xlarge" placeholder="Add Email " name="email" id="email" value="<?php echo htmlentities(stripslashes($userData[7])); ?>"></td>
				<td></td>
				</tr>
                
                <tr >
				<td align="left" class="blackbold">Voucher number *</td>
				<td><input type="text" class="form-control input-width-xlarge" placeholder="Add Voucher no " name="voucher" id="voucher" value="<?php echo htmlentities(stripslashes($userData[42])); ?>"></td>
				<td></td>
				</tr>
                <tr >
				<td align="left" class="blackbold">Date of reservation *</td>
				<td><input type="text" class="form-control input-width-large datepicker" data-mask="99/99/9999" placeholder="Click For  date " name="checkin" id="checkin" value=""></td>
				<td></td>
				</tr>
                <tr >
				<td align="left" class="blackbold">Restaurent </td>
				<td><input type="text" class="form-control input-width-large "  placeholder="Restaurent Name " name="restaurent" id="restaurent" value=""></td>
				<td></td>
				</tr>
                
                 
                <tr >
				<td align="left" class="blackbold">Timing*</td>
				<td><input type="text" class="form-control input-width-large "  placeholder="Enter timing " name="timing" id="timing" value=""></td>
				<td></td>
				</tr>
                
                 <tr >
				<td align="left" class="blackbold">PAX*</td>
				<td><input type="text" class="form-control input-width-large "  placeholder="Enter number of persons" name="persons" id="persons" value=""></td>
				<td></td>
				</tr>
                
                <tr >
				<td align="left" class="blackbold">Benefits *</td>
				<td>	<label class="radio-inlines">
												<input type="radio" class="uniforms" name="benefits" value="1" checked>&nbsp;&nbsp;&nbsp;Complimentry</label>&nbsp;&nbsp;&nbsp;/ &nbsp;&nbsp;&nbsp;
											<label class="radio-inlines"><input type="radio" class="uniforms" name="benefits" value="2" >&nbsp;&nbsp;&nbsp;Paid
											</label></td>
				<td></td>
				</tr>
                <tr >
				<td align="left" class="blackbold">Additional Info *</td>
				<td><input type="text" class="form-control input-width-xxlarge" placeholder="Add Additional info " name="info" id="info" value=""></td>
				<td></td>
				</tr>
                <tr >
				<td align="left" class="blackbold">  Acknowledgement</td>
				<td><textarea rows="4"  name="ack" id="ack" class="form-control " placeholder="Add Acknowledgement" style="width:100%" ><?php echo $ack; ?></textarea></td>
				<td><div class="validateText"></div></td>
				</tr>
               ...
               <tr >
				...
				<tr >
				<td>&nbsp;</td>
				<td colspan="2" align="left"><input type="hidden" value="<?php echo $aid; ?>" name="hidMid">
                <input type="hidden" value="<?php echo $prog_id; ?>" name="hidPid">
                <input type="hidden" value="<?php echo $progName; ?>" name="fromname">
                <input type="submit" name="submit" class="btn" value=" Preview & Send Table  Mail  ">&nbsp;&nbsp;&nbsp;
