...
if(isset($_GET['start']) && isset($_GET['end']) && isset($_GET['pg']) ){
		...
		$qryText="1&start=$start&end=&end&pg=$pg";
	}else{
		$pg =$_GET['pg'];
     ...
     <script>
		function seachByDate(start,end,program){
			...
			//}else{
				if(start=='')start=0;
				if(end=='')end=0;
				window.location.href="allmemberreport.php?start="+start+"&end="+end+'&pg='+program;	
			//}
		}
    </script> 
		...
		<div id="content">
			<div class="container">
                  ...
                  <form action="" method="post">
                   ...
                   <div class="row">
                    <div class="col-md-2" style="padding-top:6px;">Search by </div>
                     <div class="col-md-3" style="padding-top:6px;"><select name="program" id="program" class="form-control " onChange="seachByDate(document.getElementById('startdate').value,document.getElementById('enddate').value,this.value)" ><option value="0">Select Program</option>
				...
				<?php
                   ...
                   <div class="col-md-1" style="padding-top:6px;">Sale Between</div>
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> Members <a href="reports/allmembersreport.php?start=<?php echo $start; ?>&end=<?php echo $end; ?>&type=1&pg=<?php echo $pg ?>"><img src="images/excel.png" width="24" height="24"></a>&nbsp;&nbsp;<a href="reports/allmembersreport.php?start=<?php echo $start; ?>&end=<?php echo $end; ?>&type=2&pg=<?php echo $pg ?>"><img src="images/word.png" width="26" height="26"></a></h4>
