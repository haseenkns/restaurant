...
<form action="" method="post" enctype="multipart/form-data" onSubmit="return ValidateMember()">
 <?php if($msg!=''){ ?>
        ...
        <div class="row">
            ...
            <th  data-hide="phone,tablet" style="text-align:center;">Cancel Membership</th>
  ...
  <tr bgcolor="#FFFFFF">
	...
	<td align="center"  ><a href="deactivatemembers.php?aid=<?php echo base64_encode( $fetch['id']); ?>"  > <img src="images/cancel.jpg"></a></td>
