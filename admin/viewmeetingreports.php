...
if(isset($_GET['sdate'])&&$_GET['sdate']!=''){	
	 $sdate=changeDate($_GET['sdate']);
	 $edate=changeDate($_GET['edate']);
	 $meetingIds=getTodaysMeetingByTeamBetweenDates($sdate,$edate,$team);
...
$dateText="Between " .$_GET['sdate']." and ".$_GET['edate'];
									...
									<thead>
                                         ...
                                         <tr >
                                            ...
                                            <th style="text-align:center;">Exc</th>
                                               <th style="text-align:center;">Mkt Exc</th>
