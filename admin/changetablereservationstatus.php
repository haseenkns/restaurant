...
if(isset($_POST['submit'])){
	...
	$excQry=mysql_query("UPDATE `tablemail` SET `status`='$status'  where  `id` ='$hidId'");
	if($excQry){
		header("location:tableconfirmations.php?msg=scs");	
	}else{
		header("location:tableconfirmations.php?msg=scf");		
	}
			...
			<div class="container">
				...
				<div class="page-header">
					<div class="page-title">
						...
						<span style="float:left;color:#06C;cursor:pointer;" onClick="window.location.href='tableconfirmations.php'">&laquo; &nbsp;Go Back </span>
					</div>
             ...
             <?php } ?> 
				...
				<td><div style="font-weight:bold"><?php echo $name; ?></div></td>
				...
				<td><?php echo stripslashes($userData[11]); ?></td>
				<td><div class="validateText"> </div></td>
				</tr>
                <tr >
				<td align="left" class="blackbold">Timing</td>
				<td><?php echo stripslashes($userData[12]); ?></td>
				<td><div class="validateText"> </div></td>
				</tr>
                <tr >
				<td align="left" class="blackbold">Pax</td>
				<td><?php echo stripslashes($userData[15]); ?></td>
				<td><div class="validateText"> </div></td>
				</tr>
				...
				<td><div class="validateText"> </div></td>
                    ...
                    <option value="0" <?php if($userData[4]==0){ ?> selected <?php } ?>>Pending</option>
                    <option value="1" <?php if($userData[4]==1){ ?> selected <?php } ?>>Confirmed</option>
                    <option value="2" <?php if($userData[4]==2){ ?> selected <?php } ?>>Cancelled</option>
                    </select></td>
                    <td><div class="validateText"> Change status of reservation </div></td>
                    </tr>
                   
                    <tr>
                <td></td>
				<td  class="blackbold" colspan="2" align="left"><input type="hidden" name="hidId" value="<?php echo $rid; ?>"><input style="width:200px;" type="submit" name="submit" value="  Submit Details  "  class="btn">&nbsp;&nbsp;&nbsp;&nbsp;<input style="width:120px;" type="button" name="cancel" value="  Go Back" onClick="javascript:window.location.href='roomconfirmations.php'" class="btn"> </td>
