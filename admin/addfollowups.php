...
if( $leadtype==4){
	...
	$meetingdate=getLatestFollowUpDatesByLid($hidLid);
	$meetingtime=date("h:m a");
...
$excQry=mysql_query("INSERT INTO `followups` (`id`, `lid`, `conversation`, `meetingdate`, `meetingtime`, `pdate`, `ptime`, `status`) VALUES (NULL,'$hidLid','$conversation',  '$meetingdate', '$meetingtime' ,'$pdate','$ptime','1');");
if(!$excQry){
		$flag=0;		
	}
...
if($leadtype==3){
$upQry=mysql_query("Update `leads` set `ecost`='$ecost' ,`servicetax`='$servicetax' ,`taxinclusion`='$taxinclusion' ,`dateofsale`='$dateofsale' where `id`='$hidLid'");
	$orderqty=$_POST['orderqty'];
		for($i=1;$i<=$orderqty;$i++){
			 if(isset($_POST['paymentplan'.$i]) && $_POST['paymentplan'.$i]!='' ){
				...
				$insQry=mysql_query("INSERT INTO `paymentplans` (`id`, `lid`, `a_id`, `description`, `cost`) VALUES (NULL, '$hidLid', '$adminId', '$description', '$cost')");
	...
	if($flag==1 ){
		mysql_query("COMMIT");
		header("location:viewfollowups.php?msg=ups");					  
	}else{
		mysql_query("REVOKE");
		header("location:viewfollowups.php?msg=upf");	
	}
	...
	<div id="container">
		...
		<div id="content">
			<div class="container">
				...
				<!-- /Page Header -->
<form action="" method="post" name="leadform" enctype="multipart/form-data" onSubmit="return ValidateLead()">
 <?php if($msg!=''){ ?>
             <div class="row">
             <div class="col-md-12">
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i>Add Lead Followups</h4>
							</div>
                            ...
                            <div class="widget-content">        
                                  ...
                                  <div class="form-group">
									...
									<span class="title"><input type="radio" <?php if($fetch['id']==1) {?> checked <?php }?> onClick="showDateTimeDiv(this.value)"  name="leadtype" value="<?php echo $fetch['id'] ?>"></span>
                                    ...
                                    <div class="form-group" style="display:block;" id="meetingdatetimediv">
                                            ...
                                            <div class="col-md-1" >
                                                ...
                                                <label class="control-label">Next (Followup / Meeting)  Time</label>
													<input type="text" name="meetingtime" id="meetingtime" class="form-control" >
