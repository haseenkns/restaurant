 ...
 <?php if($msg!=''){ ?>
        ...
        <div class="row">
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> Cancel Members</h4>
            ...
            <th  data-hide="phone,tablet" style="text-align:center;">Action</th>
									...
									<tbody>
										<?php 
  	$sqlQry=mysql_query("select * from `members` where `status`='2' order by `id` Desc");
	$i=0;
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td align="left" class="smallfonttext">Cancelled</td>
	<td align="center"  ><a href="deactivatemembers.php?aid=<?php echo base64_encode( $fetch['id']); ?>"  >Update Details</a></td>
