...
if(isset($_GET['msg'])&&$_GET['msg']!=''){	
	...
	case 'scs':
		$msg='Table Reservation status changed successfully !!';
		$class='success';
	break;
	
	case 'scf':
		$msg='Table Reservation status not changed successfully !!!!';
		$class='danger';
	break;
...
<head>
    ...
    function cardmsg(id){
		//alert(id)
		swal({
		title: "Table Reservation Status",
		text: "Want to change ?",
		type: "warning",
		confirmButtonText: "Yes",
 		...
 		confirmButtonColor: "#DD6B55"
			...
			window.location.href='changetablereservationstatus.php?id='+id
		});
			//return false;
		}
		...
		<div id="content">
			<div class="container">
				...
				<div class="page-header">
                    ...
                    <div class="col-md-3">
					<div class="page-title">
						<h5 class="help-block align-right"   style="color:#069;cursor:pointer;text-align:right;float:right;" ></h5>
					</div>
					</div>
 ...
 <?php if($msg!=''){ ?>
  ...
  <th width="5%" >View</th>
            ...
            <th width="10%"  data-hide="phone">From</th>
             ...
             <th width="10%"  data-hide="phone,tablet" style="text-align:center;"> Change Status</th>
  </tr>
									...
									<tbody>
										<?php 
  	$sqlQry=mysql_query("select * from `tablemail`  order by `id` Desc");
	$i=0;
  ...
  <tr bgcolor="#FFFFFF">
       ...
       <td align="left" class="smallfonttext" style="text-align:center;cursor:pointer;" onClick="cardmsg('<?php echo $fetch["id"] ?>')"><?php echo getTableMailStatus($fetch['status']) ?></td>
