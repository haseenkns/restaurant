 ...
 <?php if($msg!=''){ ?>
  ...
  <th width="5%" >View</th>
            ...
            <th width="10%"  data-hide="phone">From</th>
             ...
             <th width="10%"  data-hide="phone,tablet" style="text-align:center;"> Change Status</th>
									...
									<tbody>
										<?php 
  	$sqlQry=mysql_query("select * from `roommail`  order by `id` Desc");
	$i=0;
  ...
  <tr bgcolor="#FFFFFF">
       <td align="center" class="smalltext"><?php echo $i; ?></td>
        <td align="center" class="smalltext"><a href="viewroommail.php?id=<?php echo $fetch['id']; ?>"  > <button type="button" class="btn"><i class="icon-desktop"></i></button></a></td>
       ...
       <td align="left" class="smallfonttext" style="text-align:center;cursor:pointer;" onClick="cardmsg('<?php echo $fetch["id"] ?>')"><?php echo getRoomMailStatus($fetch['status']) ?></td>
