...
if(isset($_GET['type'])){
	$type =	$_GET['type'];
	$leadName=getLeadName($type);
	
	
	$leadIds=getTotalFollowOrMeetingByDateAndType($type);
	$impIds=implode(",",$leadIds);
	//print_r($leadIds);
}
...
<body class="theme-dark">
			...
			<div class="container">
				...
				<div class="page-header">
					<div class="page-title">
						<h3>View All Leads - <b style="font-weight:normal;color:#06C;"><?php echo $leadName; ?></b></h3>
						...
						<div class="widget box">
							...
							<div class="widget-content no-padding">
								<table  class="table table-striped table-bordered table-hover table-checkable table-responsive  datatable">
									...
									<tbody>
										<?php 
									//	echo "select * from `leads` where `status`!='2' and `id` IN ($leadIds)  order by `id` Desc";
  	$sqlQry=mysql_query("select * from `leads` where `status`!='2' and `id` IN ($impIds)  order by `id` Desc");
	$i=0;
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td align="center"  ><?php echo getLeadStatus($fetch['leadtype']); ?></td>
  </tr>
  <?php }}else{?>
