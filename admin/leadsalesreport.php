...
header("location:fullsalesreport.php?month=$curMonth&year=$curYear");
				...
				<div class="row">
					...
					<div class="col-md-8">
						<div class="widget box">
                            ...
                            <table width="100%" border="0" class="table datatable" cellspacing="5" cellpadding="10">
  <tr>
    <td>Month</td>
    <?php foreach($getMonthArr as $month){ ?><td align="center"><?php echo $month ?></td><?php } ?>
  </tr>
  
     <tr><td colspan="13" style="border-bottom:dotted 1px #CCCCCC">&nbsp;</td></tr>
  <tr>
    <td>No of Sales</td>
