		...
		<div id="content">
			<div class="container">
				...
				<div class="page-header">
                   ...
                   <div class="row">
                   <div class="col-md-12" style="padding-top:6px;font-size:15px;"><a href="reports/completenominationreports.php?<?php echo $qryText; ?>&type=1">Download Comprehensive Report (memberwise referrences)</a></div>
