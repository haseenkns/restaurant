...
if(isset($_GET['msg'])&&$_GET['msg']!=''){	
	...
	if(isset($_GET['start']) && isset($_GET['end']) && isset($_GET['pg']) ){
		...
		$pg =$_GET['pg'];
		$type =$_GET['type'];
		$getTableMemIds=searchMembersByTableReservations($pg,$start,$end,$type);
	}else{
		$getTableMemIds=allTableMembers()	;
	}
...
<head>
    ...
    <script>
		function seachByDate(start,end,program,type){
				...
				window.location.href="tablereservationreports.php?start="+start+"&end="+end+'&pg='+program+'&type='+type;	
...
<form action="" method="post" enctype="multipart/form-data" onSubmit="return ValidateMember()">
 <?php if($msg!=''){ ?>
        ...
        <div class="row">
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> Table Reservation Reports - <?php echo getBrdCrumbforReservationrmembers($pg,$type,$start,$end)?></h4>
            ...
            <th  data-hide="phone,tablet" style="text-align:center;">Recerv.Date</th>
            <th  data-hide="phone,tablet" style="text-align:center;color:#06C;">Benefits</th>
            <th  data-hide="phone,tablet" style="text-align:center;">Restaurent</th>
            <th  data-hide="phone,tablet" style="text-align:center;">Pax</th>
  ...
  <tr bgcolor="#FFFFFF">
       ...
       <td align="center"  ><a href="viewmember.php?aid=<?php echo base64_encode( $mids); ?>"  > <button type="button" class="btn"><i class="icon-desktop"></i></button></a></td>
        ...
        <td align="center"  class="smallfonttext" ><?php echo $reservationDate; ?></td>
        ...
        <td align="left" class="smallfonttext"><?php echo $restaurent; ?></td>
