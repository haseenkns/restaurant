...
<body class="theme-dark">
    ...
    <td align="left" class="smallfonttext"><?php echo $clientName; ?></td>
     ...
     <td align="left" class="smallfonttext"><?php echo stripslashes($fetch['email']); ?></td>
      <td align="left" style="text-align:center;" class="smallfonttext"><span  style="font-style:normal;font-weight:700;color:#06C;"><?php  echo getExecNameBYLid($id); ?></span></td>
     ...
     <td align="left" style="text-align:center;" class="smallfonttext"><?php echo $followupDate; ?></td>
   <!-- <td align="center"  ><span class="label label-success"><a href="addfollowups.php?id=<?php echo base64_encode($fetch['id']) ?>" style="text-decoration:none;color:#FFF;">Add Follow Up</a></span></td>-->
    ...
    <td align="left" class="smallfonttext"><?php echo $clientName; ?></td>
	 ...
	 <td align="left" style="text-align:center;" class="smallfonttext"><span  style="font-style:normal;font-weight:normal;color:#06C;"><?php  echo getMarketingExecNameBYLid($id); ?></span></td>
     <td align="left" style="text-align:center;" class="smallfonttext"><?php echo $followupDate; ?></td>
    <!--<td align="center"  ><span class="label label-success"><a href="addfollowups.php?id=<?php echo base64_encode($fetch['id']) ?>" style="text-decoration:none;color:#FFF;">Add Follow Up</a></span></td>-->
  </tr>
