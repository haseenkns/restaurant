...
if(isset($_POST['submitpreview'])){
		...
		$restaurent=mysql_real_escape_string($_POST['restaurent']);
		...
		if(1){
		$excQry=mysql_query("INSERT INTO `tablemail` (`id`, `mem_id`, `pdate`, `ptime`, `status`, `postedby`, `subject`, `content`,`fromemail`,`toemail`,`prog_id`,`restaurent`,`timing`,`benefits`,`additionalinfo`,`persons`,`checkin`) VALUES (NULL, '$hidMid', '$pdate', '$ptime', '0', '$adminId', '$subject', '$msg','$from','$to','$hidPid','$restaurent','$timing','$benefits','$additionalinfo','$persons','$checkin');");
	if($excQry){
		$flag=1;	 
	}else{
		$flag=0;	
	...
	if($flag==1 ){
		mysql_query("COMMIT");
		header("location:thankstablereservation.php?msg=ins");					  
	}else{
		mysql_query("REVOKE");
		header("location:thankstablereservation.php?msg=inf");	
	}
...
$membercheckin="Date of Reservation : <b>".$_POST['checkin']."</b>";

$memberrestaurent="Restaurent : <b>".$_POST['restaurent']."</b>";
$membertiming="Timings : <b>".$_POST['timing']."</b>";
$memberpersons="PAX : <b>".$_POST['persons']."</b>";

$memberbenefits="Benefits : ".$benefitsText;
...
$message=$contents."<BR/><BR/><hr/>".$memberName."<BR/><BR/>".$memberNo."<BR/><BR/>".$memberAdd."<BR/><BR/>".$memberContact."<BR/><BR/>".$memberEmail."<BR/><BR/>".$memberVoucher."<BR/><BR/>".$membercheckin."<BR/><BR/>".$memberrestaurent."<BR/><BR/>".$membertiming."<BR/><BR/>".$memberpersons."<BR/><BR/>".$memberInfo."<BR/><BR/>".$ack."<BR/>".$remark."<br/><br/><br/>".$disclaimer;
			...
			<div class="container">
				...
				<div class="page-header">
					<div class="page-title">
						<h3>Table Reservation For - <?php echo stripslashes($progName); ?> </h3>
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i>Table Reservation Mail </h4>
							</div>
			 ...
			 <?php }?>
              ...
              <tr>
				...
				<td colspan="2" align="left">
                    ...
                    <input type="hidden" value="<?php echo $_POST['restaurent']; ?>" name="restaurent">
                    <input type="hidden" value="<?php echo $_POST['timing']; ?>" name="timing">
                    <input type="hidden" value="<?php echo $_POST['persons']; ?>" name="persons">
                    ...
                    <input type="submit" name="submitpreview" class="btn" value=" Send Table Reservation  Mail  ">&nbsp;&nbsp;&nbsp;
                    <input type="button" name="cancel" value=" Cancel & Go Back " onClick="javascript:window.location.href='sendtablereservation.php?aid=<?php echo base64_encode($_POST['hidMid']); ?>'" class="btn"></td>
				</tr>
