...
$delQry=mysql_query("delete from `genders` where `id`='$did'");
	if($delQry){
		header("location:genders.php?msg=dls");
	}else{
		header("location:genders.php?msg=dlf");
	}
}
...
$sqlQry="insert into `genders` set `name`='$name',`status`='1'";
$execQry=mysql_query($sqlQry);
if($execQry){
	header("location:genders.php?msg=ins");
}else{
	header("location:genders.php?msg=inf");
}
...
$name=mysql_real_escape_string($_POST['name']);
$id=$_POST['hidval'];
$sqlQry="Update `genders` set `name`='$name' where `id`='$id' ";
$execQry=mysql_query($sqlQry);
if($execQry){
	header("location:genders.php?msg=ups");
}else{
	header("location:genders.php?msg=upf");
}
...
<body class="theme-dark">
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> Add genders</h4>
							</div>
             ...
             <?php } ?>
              ...
              <tr>
				...
				<?php if(isset($_GET['eid'])&&$_GET['eid']!=''){ 
					...
					$execQry=mysql_fetch_row(mysql_query("select * from `genders` where `id`='$eid'"));
					$name=$execQry[1];
				...
				<tr >
				<td width="17%" align="left" class="blackbold">Update  genders Name</td>
				...
				<tr >
				<td>&nbsp;</td>
				<td colspan="2" align="left"><input type="submit" name="update" class="btn" value=" Update genders	 ">&nbsp;<input type="button" name="cancel" value=" Cancel " onClick="javascript:window.location.href='genders.php'" class="btn"></td>
				</tr>
				
				<?php }else{?>
				<tr >
				<td align="left" class="blackbold">Add genders  Name</td>
				...
				<tr >
				<td>&nbsp;</td>
				<td colspan="2" align="left"><input type="submit" name="submit" class="btn" value=" Add genders  ">&nbsp;<input type="button" name="cancel" value=" Cancel " onClick="javascript:window.location.href='genders.php'" class="btn"></td>
				</tr>
				<?php } ?>
  				</form>
</table>
			  ...
			  <tr><td colspan="2">
                ...
                <div class="row">
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> genders</h4>
  ...
  <?php 
  	$sqlQry=mysql_query("select * from `genders` order by `id`");
	$i=0;
  ...
  <tr bgcolor="#FFFFFF">
	...
	<tr >
		<td align="right" ><a href="genders.php?did=<?php echo base64_encode($fetch['id']) ?>"  class="confirm-dialog" onClick="return confirm(' Are you sure you want to delete !!')"><button class="btn"><i class="icon-trash"></i></button></a></td>
		<td align="center" ><a href="genders.php?eid=<?php echo base64_encode($fetch['id']) ?>"><button class="btn"><i class="icon-edit"></i></button>	</a></td>
        
        
		<td align="left"  ><input class='uniform' type="checkbox" id="check<?php echo $fetch['id']  ?>" value="<?php echo $fetch['status']  ?>" onClick="updateStatus('<?php echo $fetch['id'];  ?>','genders',2)" <?php if($fetch['status']==1){echo 'checked';} ?>></td>
