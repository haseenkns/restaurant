			...
			<div class="container">
				...
				<div class="page-header">
					<div class="page-title">
						<h3>Room Reservations - Pending </h3>
					</div>
...
<form action="" method="post" enctype="multipart/form-data" onSubmit="return ValidateMember()">
 <?php if($msg!=''){ ?>
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> Pending Room Reservations</h4>
   ...
   <th width="5%" >View</th>
            ...
            <th width="10%"  data-hide="phone">From</th>
             ...
             <th width="10%"  data-hide="phone,tablet" style="text-align:center;"> Confirmation</th>
									...
									<tbody>
										<?php 
  	$sqlQry=mysql_query("select * from `roommail` where `status`='0'  order by `id` Desc");
	$i=0;
  ...
  <tr bgcolor="#FFFFFF">
       ...
       <td align="left" class="smallfonttext" style="text-align:center;" ><?php echo getRoomMailStatus($fetch['status']) ?></td>
