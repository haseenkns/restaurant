...
if(isset($_GET['msg'])&&$_GET['msg']!=''){	
	...
	switch($msg){
	case 'ins':
		$msg='Program has been added Successfully !!';
		$class='success';
	break;
	
	case 'inf':
		$msg='Program not inserted Successfully !!';
		$class='danger';
	break;
	case 'ups':
	...
	case 'upf':
		$msg='Program data not updated Successfully !!';
		$class='danger';
	break;
	...
	break;
	case 'dls':
		$msg='Program data deleted successfully !!';
		$class='success';
	break;
	
	case 'dlf':
		$msg='Program data not deleted successfully !!!!';
		$class='danger';
	break;
	...
	break;
		...
		case 'ads':
		$msg='Program rights added successfully !!';
		$class='success';
	break;
	
	case 'adf':
		$msg='Program rights not added successfully !!!!';
		$class='danger';
	break;
