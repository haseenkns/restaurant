...
<body class="theme-dark">
  ...
  <tr>
	...
	?><td align="center"><a href="fullnireport.php?month=<?php echo $month ?>&year=<?php echo $curYear ?>"><?php echo getNICountByDateAndId($month,$curYear,$team); ?></a></td><?php } ?>
  </tr>
                    ...
                    <div class="col-md-4">
						<div class="widget box">
                            ...
                            <div class="row">
                            <div class="col-md-6">
                              <h4><i class="icon-reorder"></i>Not Interested</h4>
                            </div>
