...
<body class="theme-dark">
			...
			<div class="container">
				...
				<div class="page-header">
					<div class="page-title">
						<h3> Target Management - <?php echo getEmployeeNameById($aid) ?></h3>
					  <span><a href="addusers.php">Go Back To Employee</a></span>
					</div>
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> Add Target</h4>
							</div>
             ...
             <?php } ?>
              ...
              <tr>
				...
				<?php if(isset($_GET['eid'])&&$_GET['eid']!=''){ 
					...
					$execQry=mysql_fetch_row(mysql_query("select * from `target` where `id`='$eid'"));
					$name=$execQry[1];
					$edate=$execQry[3];
					$edateend=$execQry[4];
				...
				<tr >
				<td width="17%" align="left" class="blackbold">Update Target</td>
				<td width="44%"><input type="text"  class="form-control input-width-large"   autocomplete="off" style="letter-spacing:1px;"  title=""  size="45" name="name" value="<?php echo $name; ?>"><input type="hidden" name="hidval" value="<?php echo $eid;  ?>"></td>
				<td width="39%">&nbsp;</td>
				</tr>
				...
				<tr >
				<td>&nbsp;</td>
				<td colspan="2" align="left"><input type="hidden" name="hidAid"  value="<?php echo $aid ?>"><input type="submit" name="update" class="btn" value=" Update target	 ">&nbsp;<input type="button" name="cancel" value=" Cancel " onClick="javascript:window.location.href='addtarget.php'" class="btn"></td>
				</tr>
				
				<?php }else{?>
				<tr >
				<td align="left" class="blackbold">Add Target</td>
				<td width="44%"><input class="form-control  input-width-large"   autocomplete="off" style="letter-spacing:1px;"   title="" type="text" name="name"></td>
				<td width="39%" >&nbsp;</td>
				</tr>
				<tr >
				...
				<tr >
				<td>&nbsp;</td>
				<td colspan="2" align="left"><input type="hidden" name="hidAid"  value="<?php echo $aid ?>"><input type="submit" name="submit" class="btn" value=" Add target  ">&nbsp;<input type="button" name="cancel" value=" Cancel " onClick="javascript:window.location.href='addusers.php'" class="btn"></td>
				</tr>
				<?php } ?>
  				</form>
</table>
			  ...
			  <tr><td colspan="2">
                ...
                <div class="row">
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> Target</h4>
  ...
  <tr >
    ...
    <th align="left"  width="37%"class="verysmalltextblack">Target</th>
  ...
  <?php 
  	$sqlQry=mysql_query("select * from `target` where `emp_id` ='$aid' order by `id` Desc");
	$i=0;
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td align="center" >
      <table    border="0" cellpadding="0" cellspacing="0" style="padding:0px">
        <tr >
          <td align="right" ><a href="addtarget.php?did=<?php echo base64_encode($fetch['id']) ?>&aid=<?php echo base64_encode($aid) ?>"  class="confirm-dialog" onClick="return confirm(' Are you sure you want to delete !!')"><button class="btn"><i class="icon-trash"></i></button></a></td>
          <td align="center" ><a href="addtarget.php?eid=<?php echo base64_encode($fetch['id']) ?>&aid=<?php echo base64_encode($aid) ?>"><button class="btn"><i class="icon-edit"></i></button>	</a></td>
          
          
          
          <td align="left"  ><input class='uniform' type="checkbox" id="check<?php echo $fetch['id']  ?>" value="<?php echo $fetch['status']  ?>" onClick="updateStatus('<?php echo $fetch['id'];  ?>','target',2)" <?php if($fetch['status']==1){echo 'checked';} ?>></td>
