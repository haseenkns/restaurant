									...
									<thead>
                                         ...
                                         <!--   <th  data-hide="phone">Email</th>-->
                                          <!--  <th data-hide="phone,tablet">Location</th>-->
                                            <th  data-hide="phone">Enquiry Date </th>
                                            <th  data-hide="phone" style="text-align:center;">BDM</th>
  ...
  <tr bgcolor="#FFFFFF">
   ...
   <!--  <td align="left" class="smallfonttext"><?php echo stripslashes($fetch['email']); ?></td>-->
	<!--<td align="left" class="smallfonttext" style="text-align:center;"><?php echo getClientLocation($id); ?></td>-->
     <td align="left" style="text-align:center;" class="smallfonttext"><?php echo changeToStdDate(changeDate($fetch['doa'])); ?></td>
     <td align="center"  ><span  style="font-style:normal;font-weight:700;color:#06C;"><?php  echo getMarketingExecNameBYLid($id); ?></span></td>
     <td align="center"  ><span><?php echo getLeadStatus($fetch['leadtype']); ?></span></td>
     <td align="center"  ><table    border="0" cellpadding="0" cellspacing="0" style="padding:0px">
	<tr >
		<!--<td align="right" ><a href="addleads.php?did=<?php echo base64_encode($fetch['id']) ?>"  class="confirm-dialog" onClick="return confirm(' Are you sure you want to delete !!')"><button class="btn"><i class="icon-trash"></i></button></a></td>-->
