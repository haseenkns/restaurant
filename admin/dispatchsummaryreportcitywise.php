...
$city=array();
	$dispatchCityWise=getTotalDispatchCityWise($stateid,$startdate,$enddate,$pg);
	if(count($dispatchCityWise)>0){
		foreach($dispatchCityWise as $memId){
			$city[]=getCityByMemberId($memId);	
		}
	...
	$cityArr=array_count_values($city);		
...
<body class="theme-dark">
								...
								<table  class="table table-striped table-bordered table-hover table-checkable table-responsive  datatable">
									<thead>
                                         <tr >
                                            ...
                                            <th width="28%" data-hide="phone,tablet" style="text-align:left;">City</th>
                                              <th width=""  data-hide="phone" style="text-align:center">Number Of Dispatches</th>
 ...
 if(count($cityArr)>0){
		foreach($cityArr as $city=>$values){
  ...
  ?>
            ...
            <td align="left" class="smallfonttext"><?php echo $city; ?></td>
             <td align="left" class="smallfonttext" style="text-align:center;" ><b><?php echo $values; ?></b></td>
           
  </tr>
  <?php }}else{?>
  <tr style="background:#FFF;"><td></td><td>No Records</td><td></td></tr>
