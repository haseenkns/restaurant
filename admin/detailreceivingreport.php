...
<body class="theme-dark">
		...
		<div id="content">
			<div class="container">
                ...
                <div class="col-md-4"><div class="page-title">
						...
						<span> <a href="fullsalesreport.php?month=<?php echo $month ?>&yeaR">Go Back</a> </span>
					</div></div>
	...
	//echo $totalAmt;	
		...
		<tr bgcolor="#FFFFFF">
            ...
            <td align="center" class="smallfonttext"><span style="cursor:pointer;color:#06F;" class="bs-popover"  data-trigger="hover" data-placement="top" data-content="<?php echo stripslashes($addInfo) ;?>" data-original-title="Additional Info"><?php echo getModeofPayment($mode); ?></span></td>
