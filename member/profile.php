                        ...
                        <div class="span9">
                          <div class="form-horizontal">
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                                <a id="lastName" style="padding: 5px 10px;display: block;">
                                  Srinu
								  </a>
                              </div>
                            </div>
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                                <a id="location" style="padding: 5px 10px;display: block;">
                                  Banglore, India.
                                </a>
                              </div>
                            </div>
                            <div class="control-group">
                              ...
                              <div class="controls">
                                <a id="url" style="padding: 5px 10px;display: block;">
                                  01/07/1995
                                </a>
                              </div>
                            </div>
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                                <a style="padding: 5px 10px;display: block;">
                                  About me :)
                                </a>
                              </div>
                            </div>
