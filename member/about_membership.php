  ...
  <div id="mainnav" class="hidden-phone hidden-tablet">
    <ul style="display: block;">
      ...
      <li> <a href="setting.php">
        <div class="icon"> <span class="fs1" aria-hidden="true" data-icon="&#xe0b8;"></span> </div>
        Setting </a> </li>
      <li class="active"> <a href="about_membership.php">
        <div class="icon"> <span class="fs1" aria-hidden="true" data-icon="&#xe096;"></span> </div>
        Membership </a> </li>
        ...
        <div class="span12">
          <div class="widget no-margin">
            <div class="widget-header">
              <div class="title"> <span class="fs1" aria-hidden="true" data-icon="&#xe15a;"></span> Membership </div>
            </div>
            <div class="widget-body">
              <div class="row-fluid">
                ...
                <div class="span12">
                  <div class="row-fluid">
                    <div class="span12">
                      <center/><h4><strong><a href="#">You have gold membership plan</a></strong></h4></center>
                    </div>
                  </div>
                  ...
                  <div class="row-fluid">
					...
					<center>
                      <table>
						<tr>
							<td><h5>Allow free upload images</h5></td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;</td>
							<td>2</td>
						</tr>
						<tr>
							<td><h5>Remaing images</h5></td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</td>
							<td>1</td>
						</tr>
					  </table></center/>
				...
				*
				...
				<div class="span12">
                  <div class="row-fluid">
                    <div class="span12">
                      <center/>
						<h4><strong><a href="#">You have not any membership plan</a></strong></h4><br/><br/>
						<p><a class="btn btn-info" href="../membership.php">Take a membership plan</a></p>
					</center>
                    </div>
                  </div>
