...
if ($pagegroup== ""){
   ...
   /* if (($curpage != 1) && ($curpage)) 
    ...
    { 
       ...
       $page_list .= "<a href=\"".$_SERVER['PHP_SELF']."?page=".($spage).$str1."\" title=\"Previous Page\" class=\"smalla1\"><b>Previous $limitset pages....</b></a> ";
    } 
     ...
     { 
	  ...
	  if ($i > ($startpage + $limitset))
       ...
       { 
         ...
         $page_list .= ""."<span class=\"pageselected\">".$i."</span>"; 
       } 
       else 
       { 
         $page_list .= "<a href=\"".$_SERVER['PHP_SELF']."?page=".$i.$str1."\" title=\"Page ".$i."\" class='pagea'>".$i."</a>";
       } 
       $page_list .= " "; 
     } 
    $nextgrouppage = $pagegroup * $limitset;
     ...
     { 
	   ...
	   $page_list .= "<a href=\"".$_SERVER['PHP_SELF']."?page=".($spage).$str1."\" title=\"Next PageSet\"><span class=\"smalla1\"><b>....Next $limitset Pages</b></span></a> ";
     } 
     $page_list .= "\n"; 
     return $page_list; 
    } 
   ...
   ***********************************************************************************/ 
   ...
   { 
     ...
     if (($curpage-1) <= 0) 
      { 
       $next_prev .= "<td><span >"."<img src='images/prev.png' />"."</span></td>"; 
      } 
     else 
      { 
       $next_prev .= "<td><a href=\"".$_SERVER['PHP_SELF']."?page=".($curpage-1).$str."\" >"."<img src='images/prev.png' />"."</a></td>"; 
      } 
     //$next_prev .= " <font color=#000000>|</font> ";
	 //$tom= $_GET['page'];	
	 $next_prev .= "<td><span class='grayfour'>".$_GET['page']."</span></td>";   
	
     if (($curpage+1) > $pages) 
      { 
       $next_prev .= "<td><span >"."<img src='images/next.png' />"."</span></td>"; 
      } 
     else 
      { 
       $next_prev .= "<td><a href=\"".$_SERVER['PHP_SELF']."?page=".($curpage+1).$str."\" >"."<img src='images/next.png' />"."</a></td>"; 
      } 
     $next_prev .= "\n";
     return $next_prev; 
    } 
				...
				function showmsg($text,$type,$align='left')
				{
					...
					?>
<p class=normaltextnotbold align=<?=$align?> style="font-family:arial; font-size:11px; color:<?=$color?>;padding:4px;"><?php echo $text; ?></p>
<?php
				}			
